...
@Component({
  ...
  imports: [RouterOutlet, RouterLink, MatToolbarModule, MatButtonModule, MatIconModule, NgForOf, AuthenticationSectionComponent],
...
export class AppComponent {
  ...
  options = [
    ...
    {path: '/sign-in', title: 'Sign In', icon: 'https://previews.123rf.com/images/giamportone/giamportone2103/giamportone210300896/166486349-icono-de-inicio-de-sesi%C3%B3n-s%C3%ADmbolo-de-usuario-vectorial-pictograma-lineal-simple-iniciar-sesi%C3%B3n-en.jpg'},
    {path: '/sign-up', title: 'Sign Up', icon: 'https://previews.123rf.com/images/giamportone/giamportone2103/giamportone210300896/166486349-icono-de-inicio-de-sesi%C3%B3n-s%C3%ADmbolo-de-usuario-vectorial-pictograma-lineal-simple-iniciar-sesi%C3%B3n-en.jpg'}
  ];
}
