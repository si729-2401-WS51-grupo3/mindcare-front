...
export const routes: Routes = [
  ...
  { path: 'psychologist/messages', component: PatientsCardsComponent},
  { path: 'psychologist/finance', component: PatientsCardsComponent},
  ...
  { path: 'patient/messages', component:  PsychologistCardsComponent},
  { path: 'patient/finance', component:  PsychologistCardsComponent},
